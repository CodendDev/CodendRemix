...
export default function CustomError() {
  return (
    <div className="m-auto mt-unit-2xl flex h-1/2 min-h-[270px] w-1/2 min-w-fit flex-col items-center justify-center gap-5 rounded-lg border-3 border-danger-300 bg-danger-50 p-5">
